...
class Clan(models.Model):
    ...
    male_names = models.CharField(max_length=250) #male_names_meaning = models.CharField(max_length=250)
    female_names = models.CharField(max_length=250) #female_name_meaning = models.CharField(max_length=250) 
